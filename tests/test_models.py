...
def test_transaction_sheet_header_is_the_exact_russian_user_schema() -> None:
    ...
    assert len(USER_TRANSACTION_SHEET_HEADER) == 19
    assert len(TRANSACTION_SHEET_HEADER) == len(TRANSACTION_COLUMNS) == 20
