...
### Неизвестные начисления и сверка

Типы, для которых ещё нет отдельного столбца, попадают в «Прочие или неизвестные начисления» и
отмечаются предупреждением в логе. Туда же записывается сумма операции, если Ozon не передал её
детализацию.
...
конфигурацию Compose. Остальные проверки и публикация контейнера описаны в workflow CI.
